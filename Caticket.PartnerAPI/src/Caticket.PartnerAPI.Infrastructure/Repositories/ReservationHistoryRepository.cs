...
public class ReservationHistoryRepository(DatabaseContext dbContext, TenantProvider tenantProvider) : Repository<ReservationHistory>(dbContext, tenantProvider)
{
}